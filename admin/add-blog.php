          ...
          <form action="" method="post" enctype="multipart/form-data">
            <div class="card card-outline card-info">
                ...
                <div class="form-group">
                  ...
                  <select name="category" class="form-control">
                    ...
                    while ($location_ft = mysqli_fetch_array($location)) {
                      $selected = ($roww["category"] == $location_ft["cat_name"]) ? 'selected' : '';
                      echo "<option value=\"{$location_ft['cat_name']}\" {$selected}>{$location_ft['cat_name']}</option>";
                    }
                    ?>
                  </select>
                </div>
              ...
              <div class="card-body pad">
                ...
                <div class="mb-3">
                  <textarea name="descrip" class="textarea" placeholder="Place some text here" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo $roww["descrip"] ?? ''; ?></textarea>
                </div>
              </div>
              <div class="card-header">
                <div class="form-group">
                ...
                <div class="form-group">
                  <div class="row">
                    <div class="col-sm-6">
                      <!-- text input -->
                      <div class="form-group">
                        <button type="submit" name="publish" class="btn btn-primary btn-lg">Publish Post</button>
                      </div>
                    </div>
                  </div>
                </div>
