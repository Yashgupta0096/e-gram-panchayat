            ...
            <div class="card card-outline card-info">
              <div class="card-header">
                <div class="form-group">
                  ...
                  <input type="text" name="title" value="<?php echo isset($roww["title"]) ? $roww["title"] : ''; ?>" class="form-control" placeholder="Enter ...">
                </div>
              </div>
              <div class="card-header">
                <div class="form-group">
                  <label>Enter Desc..</label>
                  <textarea name="descc" class="form-control" placeholder="Enter ..." onfocus="clearContents(this);"><?php echo isset($roww["descc"]) ? $roww["descc"] : ''; ?></textarea>
                </div>
              </div>
