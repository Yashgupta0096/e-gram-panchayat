...
<div class="wrapper">
  ...
  if (isset($_POST['publise'])) {
    ...
    if ($edit == '') {
      ...
      VALUES('$Name_child','$Name_mother','$Name_father', '$place','$dateofb','$gender' ,'$address','$lis_img')");

      echo "<script>alert('Posted Successfully');</script>";
      echo "<script>window.location.href = 'add-birth.php'</script>";
    } else {
      move_uploaded_file($tempname, $folder);

      $insertdata = mysqli_query($con, "UPDATE birth SET Name_child='$Name_child',Name_mother='$Name_mother',Name_father='$Name_father',
      place='$place',dateofb='$dateofb',gender='$gender' ,address='$address',img='$lis_img' WHERE id=" . $edit . "");
