...
<div class="wrapper">
  ...
  if (isset($_POST['publish'])) {
    ...
    if ($edit == '') {
      ...
      echo "<script>window.location.href = 'add-about.php';</script>";
    } else {
            ...
            <div class="card card-outline card-info">
              ...
              <div class="card-header">
                <div class="form-group">
                  ...
                  <img style="width: 200px; height: 150px;" src="../images/about/<?php echo $roww["img"] ?? ''; ?>">
                </div>
              </div>
              <div class="card-header">
                <div class="form-group">
                  <div class="row">
                    <div class="col-sm-6">
                      <!-- text input -->
                      <div class="form-group">
                        <button type="submit" name="publish" class="btn btn-block btn-warning btn-lg">Publish</button>
                      </div>
                    </div>
                  </div>
                </div>
